...
* `general/frontend` - The frontend root for configuration and entry points.
* `general/frontend/assets` - Static assets.
* `general/frontend/utils/client` - The generated OpenAPI client.
* `general/frontend/elements` - Shared UI components.
* `general/frontend/hooks` - Custom hooks.
* `general/frontend/routes` - File-based routes for the frontend.
